...
public class User extends AppModel implements Subject {
	...
	public static User create(final AuthUser authUser, boolean admin) {
		/*
		if(authUser instanceof  UsernamePasswordAuthUser){
			UsernamePasswordAuthUser u = (UsernamePasswordAuthUser)authUser;
			Logger.info("Creating UsernamePasswordAuthUser " + u.getEmail() + ", pw=" + u.getPassword() + ", hash=" + u.getHashedPassword());
		}
		else{
			Logger.info("Creating user " + authUser.toString());
		}
		*/
